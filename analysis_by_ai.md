...
3. **Methodology:**
   - **Study Design:** The approach involves encoding facial images into a set-latent representation using a transformer-based encoder. This is followed by decoding for facial reenactment using another transformer conditioned on the driving frame’s keypoints and facial expression vectors.
