...
def json_to_md(filename,
    ...
    with open(md_filename,"a+") as f:
        ...
        f.write("The content of this page is generated by [claude.ai](https://claude.ai/) (papers before 2024.02) or ChatGPT GPT4-Turbo (papers after 2024.02). \n\n")  
        f.write("**This page is currently **under construction** \n\n")
        f.write("**The cost of the API is high. I am exploring ways to manage it. \n\n")
